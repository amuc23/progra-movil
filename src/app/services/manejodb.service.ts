  ...
  crearBD(){
    ...
    this.platform.ready().then(()=>{
      ...
      this.sqlite.create({
        ...
        name: 'megagames1.db', //nombre conexion (luego del nombre se añade .db) al cambiar el nombre se creara una conexion nueva y se podra utilizar tablas nuevas
